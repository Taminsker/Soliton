...
{
    std::size_t order_attempt = object->GetOrderOfElement () + 1;
...
QuadStore::QuadObject::QuadObject (PHYSICAL_CELL_TYPE _type, std::size_t _npts, std::size_t _order) :
    type (_type),
    npts (_npts),
    order (_order),
    w ({}),
