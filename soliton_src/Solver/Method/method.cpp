...
void
Solver::AutoDeduceBest (const SparseMatrix *A, const PlainVector *b,
                        PlainVector* sol, bool display, int maxiter, double eps)
{
...
void
Solver::CG (const SparseMatrix *A, const PlainVector *b,
            PlainVector* sol, bool display, int maxiter, double eps)
{
    if (display)
    {
...
void
Solver::BiCGStab (const SparseMatrix *A, const PlainVector *b,
                  PlainVector* sol, bool display, int maxiter, double eps)
{
    if (display)
    {
...
void
ImposeDirichlet (Mesh* mesh, SparseMatrix* A, PlainVector* secondMember,
...
double
GetErrorl1 (Mesh * mesh, const PlainVector *u_ana, const PlainVector *u_num)
{
    VOID_USE(mesh);
...
double
GetErrorl2 (Mesh * mesh, const PlainVector *u_ana, const PlainVector *u_num)
{
    VOID_USE(mesh);
...
double
GetErrorlinf (Mesh * mesh, const PlainVector *u_ana, const PlainVector *u_num)
{
    VOID_USE(mesh);
...
PlainVector
GetErrorAbs (Mesh * mesh, const PlainVector *u_ana, const PlainVector *u_num)
{
    VOID_USE(mesh);
...
PlainVector
GetErrorRelaPercent (Mesh * mesh, const PlainVector *u_ana, const PlainVector *u_num)
{
    VOID_USE(mesh);
...
double
GetErrorRela (Mesh * mesh, const PlainVector *u_ana, const PlainVector *u_num)
{
    VOID_USE(mesh);
