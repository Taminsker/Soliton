...
DFStore::DFIdxCoeff::DFIdxCoeff () : idxs ({}),
                                     coeffs ({})
{
}
...
DFStore::DFIdxCoeff::DFIdxCoeff (const DFStore::DFIdxCoeff & tocopy) : idxs (tocopy.idxs),
                                                                       coeffs (tocopy.coeffs)
{
}

DFStore::DFIdxCoeff &
DFStore::DFIdxCoeff::operator= (const DFStore::DFIdxCoeff & tocopy)
{
    idxs   = tocopy.idxs;
    coeffs = tocopy.coeffs;
...
DFStore::DFOrders::DFOrders () : Order1 (),
                                 Order2 (),
                                 Order3 (),
                                 Order4 (),
                                 Order5 (),
...
DFStore::DerivativeStruct::DerivativeStruct () : Backward (),
                                                 Central (),
                                                 Forward ()
{
}
