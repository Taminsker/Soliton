...
ul_t FEBase::GetNumberOfPoints ()
{
    return m_coor.size ();
}

ul_t FEBase::GetNumberOfEdges ()
{
    return m_edges.size ();
}

real_t FEBase::GetMesureOfRef ()
{
    return m_volref;
}

ul_t FEBase::GetOrderOfElement ()
{
    return m_order;
}

ul_t FEBase::GetDimension ()
{
    return m_dim;
}
...
Point* FEBase::GetPoint (ul_t id)
{
    return m_coor.at (id);
}

Edge* FEBase::GetEdge (ul_t id)
{
    return m_edges.at (id);
}

Point* FEBase::GetNormalToEdge (ul_t id)
{
    return m_edges_normals.at (id);
}

Point* FEBase::GetTangentToEdge (ul_t id)
{
    return m_edges_tangents.at (id);
}

LambdaOnPoint<real_t>& FEBase::GetPhi (ul_t id)
{
    return m_phi.at (id);
}

LambdaOnPoint<Point>& FEBase::GetGradPhi (ul_t id)
{
