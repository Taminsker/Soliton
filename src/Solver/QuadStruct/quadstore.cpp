...
#include "..//FEStruct/ListOfElements/listofelements.hpp"

QuadStore::QuadStore () : m_quad_empty (nullptr),
...
QuadStore::QuadObject *
QuadStore::Get (FEBase * object)
{
...
QuadStore::QuadObject::QuadObject (PHYSICAL_CELL_TYPE _type, ul_t _npts, ul_t _order) : type (_type),
                                                                                        npts (_npts),
                                                                                        order (_order),
                                                                                        w ({}),
                                                                                        pts ({})
...
QuadStore::QuadObject *
QuadrangleFromLine (QuadStore::QuadObject * line)
{
    ul_t npts = line->npts;
    npts *= npts;
