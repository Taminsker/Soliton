#ifndef SRC_SOLVER_SOLITONFE_SOLITONFEITEM_SOLITONFEITEM_HPP
#define SRC_SOLVER_SOLITONFE_SOLITONFEITEM_SOLITONFEITEM_HPP

#include "../SolitonFEItemBase/solitonfeitembase.hpp"

template <ITEM_T t_type>
class SolitonFEItem : public SolitonFEItemBase
{
public:
    SolitonFEItem (SolitonFEContainer * parent, PHYS tag = PHYS::DEFAULT) : SolitonFEItemBase (parent, tag)
    {
    }

    SolitonFEItem (const SolitonFEItem & tocopy) : SolitonFEItemBase (tocopy)
    {
    }
    ...
    SOLITON_INLINE
    void
    SetAdditionalName (std::string name) override
    {
...
#endif /* SRC_SOLVER_SOLITONFE_SOLITONFEITEM_SOLITONFEITEM_HPP */
