...
SolitonFEItemBase::SolitonFEItemBase (SolitonFEContainer *parent, PHYS tag) :
    m_c (parent),
    m_id_target (0x0),
    m_mat(new SparseMatrix_eig()),
    m_sec(new PlainVector_eig ()),
...
SolitonFEItemBase::SolitonFEItemBase (const SolitonFEItemBase& tocopy) :
    m_c (tocopy.m_c),
...
void SolitonFEItemBase::Print (std::ostream& out)
{
...
void SolitonFEItemBase::SetSparseMatrix (std::vector<Triplet_eig> *listTriplets)
{
...
void SolitonFEItemBase::SetSecMember (std::vector<Duo> *listDuos)
{
