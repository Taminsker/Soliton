#ifndef SOLITONFECONTAINER_H
#define SOLITONFECONTAINER_H
...
#include <Solver/SolitonQueue/solitonqueue.h>
...
public:
    ...
    SOLITON_INLINE
    void
    ComputeSecMemberAndMats (std::vector<SparseMatrix_eig> *listMats, PlainVector_eig *secMember, real_t time)
    {
        ...
        for (uid_t i = 0; i < SOLITONCONTAINER_ORDER_MAX; ++i)
            listMats->at (i) = SparseMatrix_eig (numPoints, numPoints);
