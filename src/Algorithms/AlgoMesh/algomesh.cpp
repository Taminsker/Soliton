#include "algomesh.hpp"

#include "../../Core/core.hpp"
#include "../../IO/io.hpp"

void
Build_NtoN (Mesh * mesh)
{
...
void
ComputeNormalsOnEdges (Mesh * mesh)
{
#ifdef VERBOSE
...
void
ComputeNormalsOnCells (Mesh * mesh)
{
#ifdef VERBOSE
...
void
ComputeNormalsOnPoints (Mesh * mesh)
{
#ifdef VERBOSE
...
void
MoveObject (Mesh * mesh, real_t radius, Point center)
{
#ifdef VERBOSE
...
void
ComputeTagPhysical (Mesh * mesh, InputDatStruct * struc)
{
    int numPoints = mesh->GetNumberOfPoints ();
    int numCells  = mesh->GetNumberOfCells ();
    int numEdges  = mesh->GetNumberOfEdges ();
...
void
ComputeDampingArea (Mesh * mesh, PHYS tag, real_t h)
{
...
real_t
GetDampingCoeffFor (Point * atpoint, Mesh * mesh, PHYS tag, real_t h)
{
    int                        numPoints   = mesh->GetNumberOfPoints ();
